...
const QuizPage = () => {
  ...
  // Map the chunks to the questions format required
  const questions = chunks.quiz.map((chunk) => ({
    question: chunk.question,
    choices: chunk.options,
    correct: chunk.answer,
  }));
  ...
  return (
    <div className="p-8 flex flex-col  w-full">
      ...
      <div className="w-40 bg-gray-300 h-4 mb-4 rounded-2xl mx-auto">
        <div
          className="bg-secondaryPink h-4 rounded-2xl"
          style={{
      ...
      <div className="bg-secondaryBackground rounded-2xl w-full p-8 h-5/6">
        {/* Current Question */}
        <h2 className="sm:text-3xl text-xl text-center font-semibold mb-6">
        ...
        <div className="flex justify-between sm:mt-20">
          <button
            ...
            className="p-4 rounded-2xl bg-black font-semibold text-background "
          >
            Prev
          </button>
          <button
            onClick={handleNextQuestion}
            className="p-4 bg-black text-background font-semibold rounded-2xl"
          >
