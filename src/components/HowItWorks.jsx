...
const HowItWorks = () => {
  return (
    <div>
      <img src={HowItWorksVector} alt="" className="w-full -mb-1" />

      <div className="bg-primaryPink pb-10 -md:pt-36">
        <h1 className="text-center font-bold text-2xl  pt-8 md:text-5xl ">
          How It Works
        </h1>

        <div className="pt-40 md:py-40 z-10 relative md:mt-5">
