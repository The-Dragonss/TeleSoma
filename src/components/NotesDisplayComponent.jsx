...
const NotesDisplayComponent = ({ notes, backgroundImage }) => {
    ...
    return (
        ...
        >
            <div className="bg-white w-4/5 sm:p-6 rounded-2xl max-sm:h-4/5 sm:h-3/5 shadow-lg flex flex-col justify-between">
                ...
                <div className="flex justify-between items-center mt-4">
                    <button onClick={goToPrevPage} disabled={currentPage === 0} className="p-4 bg-secondaryBackground rounded-full text-2xl">
                        &larr;
                    </button>
                    <p className="text-lg">
                        {currentPage + 1}/{totalPages}
                    </p>
                    <button onClick={goToNextPage} disabled={currentPage === totalPages - 1} className="p-4 bg-secondaryBackground rounded-full text-2xl">
                        &rarr;
                    </button>
                </div>
            </div>
