...
const UserPoints = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <div className="flex justify-between items-center w-4/5 my-1 bg-white rounded-2xl">
        {/* Daily XP */}
        <div className="flex flex-col items-center bg-white rounded-lg w-1/2 mx-2">
